        ...
        <div className="pe-con">
            <div className="pe-cov">
                <div className="pe-tabs">
                    ...
                    {auth.admin && <div className={`pe-tab ${tabsStatus === "Analysis"?"pe-tabed":""}`}><Link to="/profile/history" className="pe-nav" onClick={(e) => changeMyTab("Analysis")}><BsPieChartFill/> Analysis</Link></div>}
