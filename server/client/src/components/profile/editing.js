...
const Editing = ({update_product, profile}) => {
    ...
    const removeExtra = (e, url) => {
        ...
        const newImages = extraImagesUrl.filter((img) => url !== img)
            ...
            <div className="pa-cov">
                ...
                <form className="pa-form">
                    ...
                    <div className="pa-check">
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("S")? true:false} 
                                    value="S" 
                                    className="pa-ch-input" 
                                    ref={ref1}/> S
                        </label>
                        <label className="pa-lab">
                            <input 
                                   type="checkbox" 
                                   defaultChecked={data.sizes.includes("M")? true:false} 
                                   value="M" 
                                   className="pa-ch-input" 
                                   ref={ref2}/> M
                        </label>
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("L")? true:false} 
                                    value="L" 
                                    className="pa-ch-input" 
                                    ref={ref3}/> L
                        </label>
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("XL")? true:false} 
                                    value="XL" 
                                    className="pa-ch-input" 
                                    ref={ref4}/> XL
                        </label>
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("XXL")? true:false} 
                                    value="XXL" 
                                    className="pa-ch-input" 
                                    ref={ref5}/> XXL
                        </label>
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("XXXL")? true:false} 
                                    value="XXXL" 
                                    className="pa-ch-input" 
                                    ref={ref6}/> XXXL
                        </label>
                        <label className="pa-lab">
                            <input 
                                    type="checkbox" 
                                    defaultChecked={data.sizes.includes("XXXXL")? true:false} 
                                    value="XXXXL" 
                                    className="pa-ch-input" 
                                    ref={ref7}/> XXXXL
                        </label>
